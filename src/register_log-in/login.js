                                            ...
                                            <div className="login-form">
                                                <div className="login-form-header">
                                                    <div className="login-form-header1">
                                                        <div className="login-form-header1-1">Đăng nhập</div>
                                                        <div className="login-form-header1-2">
                                                            <div className="login-form-header1-2-1">
                                                                Đăng nhập với mã QR
                                                            </div>
                                                            <Link >
                                                                <img style={{ height: '40px' }} src="https://d1uvxqwmcz8fl1.cloudfront.net/tes/resources/6429541/18b346b7-0fe3-47c8-8812-649928304400/image?width=500&height=500&version=1400571431000" alt="" />
                                                            </Link>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="login-form2">
                                                    <div className="login-form-username">
                                                        <div className="login-form-username1">
                                                            <input className="login-form-username1-1" type="text" placeholder="Email/Số điện thoại/Tên đăng nhập" />
                                                        </div>
                                                        <div className="login-form-username2"></div>
                                                    </div>
                                                    <div style={{ marginBottom: '14px' }}>
                                                        <div className="login-form-username1">
                                                            <input type="password" id="password" name="password" className="login-form-username1-1" placeholder="Mật khẩu" />
                                                        </div>
                                                        <div className="login-form-username2"></div>
                                                    </div>
                                                    <button className="login-button" disabled>Đăng nhập</button>
                                                    <div className="forgot-password">
                                                        <Link className="forgot-password1">Quên mật khẩu</Link>
                                                        <Link className="forgot-password1">Đăng nhập với SMS</Link>
                                                    </div>
                                                ...
                                                <div className="login-form3">
                                                    <div className="login-form3-1">
                                                        ...
                                                        <Link to='/signup' style={{ textDecoration: 'none', color: "#ee4d2d", paddingLeft: '5px' }}>Đăng kí</Link>
                                                    </div>
