...
import { PaymentMethod } from "./example";
      ...
      <header className="shoppee-top">
        <div className="main">
          <nav className="container">
            <div className="flex1">
              <Link className="space space1 space2" style={{ color: "#fff" }}>
                Kênh người bán
              </Link>
              <Link className="space space1 space2" style={{ color: "#fff" }}>
                Trở thành người bán Shoppee
              </Link>
              <div className="space space1 space2" style={{ color: "#fff" }}>
                Tải ứng dụng
              </div>
              <div className="space space1 " style={{ color: "#fff" }}>
                Kết nối{" "}
              </div>
            ...
            <ul className="flex2">
              <li className="space space2" style={{ color: "#fff" }}>
                <NotificationsNoneIcon />
                Thông Báo
              </li>
              <Link to="" className="space space1 space2" style={{ color: "#fff" }}>
                <HelpOutlineIcon />
                Hỗ Trợ
              </Link>
              <span className="space space1 space2" style={{ color: "#fff" }}>
                <LanguageIcon />
                Tiếng việt
              </span>
              <Link to="/signup" className="space space1 space2" style={{ color: "#fff" }}>
                Đăng Ký
              </Link>
              <Link to="/login" className="space space1 space2 " style={{ color: "#fff" }}>
                Đăng Nhập
              </Link>
            </ul>
          </nav>
            ...
            <div style={{ display: "flex", flexDirection: "column ", justifyContent: "flex-start" }}>
              <div style={{ display: "flex" }}>
                <input
                  ...
                  style={{ fontSize: "25px ", width: "840px", borderRadius: "5px" }}
                />
                <button className="button-search" style={{ border: "none", outline: "none" }}>
                  <SearchIcon style={{ color: "#fff" }} />
                </button>
              </div>
              <div class="" style={{ fontSize: "12px" }}>
                <Link to="page" className="space" style={{ color: "#fff", textDecoration: "none", fontSize: "12px" }}>
                  Dép 1k
                </Link>
                <Link className="space" style={{ color: "#fff", textDecoration: "none", fontSize: "12px" }} to="page">
                  Áo 1k
                </Link>
                <Link className="space" style={{ color: "#fff", textDecoration: "none", fontSize: "12px" }} to="page">
                  Set Kẹp Tóc
            ...
            <div style={{ marginRight: "auto", marginLeft: "auto", width: "1200px" }}>
              <div style={{ lineHeight: "0", display: "flex", minHeight: "235px", maxHeight: "235px" }}>
                  ...
                  <div id="carouselExample" class="carousel slide">
                    <div className="carousel-inner">
                      <div className="carousel-item active">
                        <img
                          src="https://cf.shopee.vn/file/vn-50009109-9f7257e7e72f64d37e901191bbc93a1a_xxhdpi"
                      ...
                      <div className="carousel-item">
                        <img
                          src="https://cf.shopee.vn/file/vn-50009109-c32c3818f495049bfdaf7d2e60673943_xxhdpi"
                          className="d-block w-100"
                          alt="..."
                        />
                      </div>
                      <div className="carousel-item">
                        <img
                          src="https://cf.shopee.vn/file/vn-50009109-d8a56cc68d63168c485902f3bbc1a7c6_xxhdpi"
                          className="d-block w-100"
                          alt="..."
                        />
                      </div>
                ...
                <div className="img-slider">
                  <Link className="img-slider1">
                    <div className="img-slider1-1">
                      <img
                        className="img-slider1-1-1"
                        src="https://cf.shopee.vn/file/vn-50009109-fb05767994d3de1374fe6c1e5e2c0747_xhdpi"
                        alt="..."
                      />
                    </div>
                  </Link>
                  <Link className="img-slider2">
                    <div className="img-slider2-1">
                      <img
                        className="img-slider2-1-1"
                        src="https://cf.shopee.vn/file/vn-50009109-fb05767994d3de1374fe6c1e5e2c0747_xhdpi"
                        alt="..."
                      />
                    </div>
      ...
      <div style={{ marginRight: "auto", marginLeft: "auto", width: "1200px" }}>
        <div style={{ marginTop: "1.25rem" }}>
          <div className="youlike1" style={{ position: "relative" }}>
            <picture>
              <img
                ...
                src="https://down-vn.img.susercontent.com/file/vn-50009109-2cf552e5d4003f099ad0bd6af2efb8b9"
                alt=""
              />
            </picture>
            <div></div>
          ...
          <div className="youlike2">
            <div className="youlike2-1" style={{ width: "36.125rem" }}>
              <div className="youlike2-1-1">
                <span className="youlike2-1-1-1" style={{ color: "rbg(255,255,255)" }}>
                  ĐỒ BẠN THÍCH Ở ĐÂY
                </span>
                <Link className="youlike2-1-1-2">
                  Xem thêm
                  <svg
              ...
              <div className="youlike2-1-2">
                <Link className="youlike2-1-2-1">
                  <div className="youlike2-1-2-1-1">
                    <img
                      className="youlike2-1-2-1-1-1"
                      src="https://down-vn.img.susercontent.com/file/vn-50009109-122faaec270ca3277198c6d0c77bb0fe_tn"
                      alt=""
                    />
                  </div>
                  <div className="youlike2-1-2-1-2">
                    <div class="youlike2-1-2-1-2-1" style={{ color: "rgb(238, 78, 46)" }}>
                      ₫169.000
                    </div>
                  </div>
                  <div className="youlike2-1-2-1-3">
                    <div class="youlike2-1-2-1-3-1">
                      <span class="youlike2-1-2-1-3-1-1">-23%</span>
                    </div>
                  </div>
                </Link>
                <Link className="youlike2-1-2-1">
                  <div className="youlike2-1-2-1-1">
                    <img
                      classPaymentMethodName="youlike2-1-2-1-1-1"
                      src="https://down-vn.img.susercontent.com/file/vn-50009109-807a1f0a40b4fc6dad3bb7ad5e0e01a5_tn"
                      alt=""
                    />
                  </div>
                  <div className="youlike2-1-2-1-2">
                  ...
                  <div className="youlike2-1-2-1-3">
                    <div class="youlike2-1-2-1-3-1">
                      <span class="youlike2-1-2-1-3-1-1">-14%</span>
                    </div>
                  </div>
                </Link>
                <Link className="youlike2-1-2-1">
                  <div className="youlike2-1-2-1-1">
                    <img
                      className="youlike2-1-2-1-1-1"
                      src="https://down-vn.img.susercontent.com/file/dc69149a669af488b6f6ff05be2b6fbb_tn"
                      alt=""
                    />
                  </div>
                  <div className="youlike2-1-2-1-2">
              ...
              <div className="youlike2-1-2">
                <Link className="youlike2-1-2-1">
                  <div className="youlike2-1-2-1-1">
                    <img
                      className="youlike2-1-2-1-1-1"
                      src="https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-lhwsava28aklad"
                      alt=""
                    />
                  </div>
                  <div className="img-th">
                    <img
                      className="img-tha"
                      src="https://down-vn.img.susercontent.com/file/9113119d5cef3292952e04c24cacc78d_tn"
                      alt=""
                    />
                  </div>
                  <div className="youlike2-1-2-1-2">
                ...
                <Link className="youlike2-1-2-1">
                  <div className="youlike2-1-2-1-1">
                    <img
                      className="youlike2-1-2-1-1-1"
                      src="https://down-vn.img.susercontent.com/file/c5fb264ed0d4cac36cb9d1f2437e6a92"
                      alt=""
                    />
                  </div>
                  <div className="img-th">
                    <img
                      className="img-tha"
                      src="https://down-vn.img.susercontent.com/file/65b1c46d37b3c9b4a56c8e7fd673838d_tn"
                      alt=""
                    />
                  </div>
                  <div className="youlike2-1-2-1-2">
                ...
                <Link className="youlike2-1-2-1">
                  <div className="youlike2-1-2-1-1">
                    <img
                      className="youlike2-1-2-1-1-1"
                      src="https://down-vn.img.susercontent.com/file/vn-11134207-23020-gkekiwhjm2mv22"
                      alt=""
                    />
                  </div>
                  <div className="img-th">
          ...
          <div style={{ height: "15px" }}>
            <picture>
              <img
                src="https://down-vn.img.susercontent.com/file/vn-50009109-4603c96ddfca3ce30d6a6a3d1d32b9a2"
                class="PLPphI"
                style={{ height: "15px" }}
                alt=""
              />
            ...
            <div style={{ paddingTop: "1.25rem" }}>
              <div className="sale-header">
                <div className="sale-header-1">
                  ...
                  <div className="sale-header-1-2"></div>
                </div>
                <Link></Link>
              </div>
              <div></div>
          ...
          <div className="customer-care">
            <div className="customer-care1">
              <div className="customer-care1-1">
                <div className="customer-care1-1-1">CHĂM SÓC KHÁCH HÀNG</div>
                <ul className="customer-care1-1-2">
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Trung tâm trợ giúp</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Shopee Blog</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Shopee Mall</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Hướng Dẫn Mua Hàng</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Hướng Dẫn Bán Hàng</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Thanh Toán</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Shopee Xu</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Vận Chuyển</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Trả Hàng & Hoàn Tiền</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Chăm Sóc Khách Hàng</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Chính Sách Bảo Hành</span>
                    </Link>
                  </li>
                </ul>
              </div>
              <div className="customer-care1-1">
                <div className="customer-care1-1-1">VỀ SHOPEE</div>
                <ul className="customer-care1-1-2">
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Giới Thiệu Về Shopee Việt Nam</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Tuyển Dụng</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Điều Khoản Shopee</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Chính Sách Bảo Mật</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Chính Hãng</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Kênh Người Bán</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Flash Sales</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Chương Trình Tiếp Thị liên kết Shopee</span>
                    </Link>
                  </li>
                  <li className="customer-care1-1-2-1">
                    <Link className="customer-care1-1-2-1-1">
                      <span className="customer-care1-1-2-1-1-1 hoverr">Liên Hệ Với Truyền Thông</span>
                    </Link>
                  </li>
                </ul>
              </div>
          ...
          <div className="policys">
            <div className="policy">
              ...
              <div className="img-footer">
                <Link className="img-footer1"></Link>
                <Link className="img-footer1"></Link>
                <Link className="img-footer1"></Link>
              </div>
              <div
