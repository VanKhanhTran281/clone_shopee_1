          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column ", justifyContent: "flex-start" }}>
              <div style={{ display: "flex" }}>
                ...
                />
                <button className="button-search" style={{ border: "none", outline: "none" }} onClick={handleSearch}>
                  <SearchIcon style={{ color: "#fff" }} />
                </button>
              </div>
              <div class="" style={{ fontSize: "12px" }}>
                <Link className="space" style={{ color: "#fff", textDecoration: "none", fontSize: "12px" }} to="">
                  Dép 1k
                </Link>
                <Link className="space" style={{ color: "#fff", textDecoration: "none", fontSize: "12px" }} to="">
                  Áo 1k
            ...
            <div>
              <div className="product-shopping-main" style={{ padding: "10px 0" }}>
                ...
                <div
                  aria-describedby="cart_drawer_target_id"
                  role="tooltip"
                  aria-hidden="false"
                  className="product-shopping"
                  style={{ top: "46px", right: "0px", transformOrigin: "381.1px top" }}
                >
                  <div
                    className="product-shopping1"
                    style={{
                      top: "1px",
                      left: "381.1px",
          ...
          <div className="product-page-contents-container">
            <div className="product-page-contents-container-filter-panel">
              <div className="page-contents-container-filter-status">
                ...
                <h2 className="shopee-search-filter-status__text">
                  Bộ lọc tìm kiếm<span class="sr-only"></span>
                </h2>
              </div>
              <SidebarContent
                data={List1}
                  ...
                  <label className="shopee-checkbox">
                    <div className="shopee-checkbox__box">
                      <input
                        ...
                        checked={selectedLocations.includes("TP. Hồ Chí Minh")}
                        onChange={handleCheckboxChange}
                      />
                    </div>
                  ...
                  <label className="shopee-checkbox">
                    <div className="shopee-checkbox__box">
                      <input
                        ...
                        name="thainguyen"
                        value="Thái Nguyên"
                        checked={selectedLocations.includes("Thái Nguyên")}
                        onChange={handleCheckboxChange}
                      />
                    </div>
              ...
              <fieldset className="shopee-filter-group ">
                ...
                <div className="shopee-filter shopee-checkbox-filter">
                  <label className="shopee-checkbox">
                    ...
                    <span className="shopee-checkbox__label">GUMEN</span>
                  </label>
                </div>
                <button aria-expanded="false" className="shopee-filter-group__toggle-btn" aria-label="">
                  Thêm
              ...
              <section style={{ marginBottom: "1.25rem" }}>
                <div style={{ paddingTop: "1.25 rem" }}>
                  <div
                    ...
                    style={{ display: "flex", alignItems: "center", paddingBottom: "0.625rem" }}
                  >
                    <div className="shopee-header-section__header__title">
                      <h1 style={{ fontSize: "unset", fontWeight: "unset", margin: "unset" }}>
                        Shop liên quan đến
                        <span>
                          <span>"</span>
                    ...
                    >
                      <button className="shopee-button-no-outline">
                        ...
                        <svg
                          ...
                          style={{ fontSize: ".625rem", color: "#ee4d2d" }}
                        >
                    ...
                    <div className="shopee-search-user-item ">
                      ...
                      <Link className="shopee-search-user-item__shop-info" href="">
                        ...
                        <div className="shopee-search-user-item__follow-count">
                          ...
                          <span> |</span>
                          <span className="shopee-search-user-item__follow-count-number">1</span>
                          <span> Đang Theo</span>
                        </div>
                      </Link>
              ...
              <section>
                <h1 className="shopee-search-result-header" style={{ margin: ".67em 0" }}>
                  ...
                  <span class="shopee-search-result-header__text">
                    ...
                    <span
                      class="shopee-search-result-header__text-highlight"
                    ...
                    <section>
                      <button className="sort-price-select">
                        ...
                        <ul class="dropdown-menu">
                          <li>
                            <Link class="dropdown-item" href="#" onClick={upProducts}>
                              Giá: Thấp đến Cao
                            </Link>
                          </li>
                          <li>
                            <Link class="dropdown-item" href="#" onClick={downProducts}>
                              Giá: Cao đến Thấp
                            </Link>
                          </li>
                        </ul>
          ...
          <div className="policys">
            <div className="policy">
              ...
              <div className="img-footer">
                <Link className="img-footer1">
                  <img
                    className="img-footer1-1"
                    src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/3ce17addcf90b8cd3952b8ae0ffc1299.png"
                    alt=""
                  />
                </Link>
                <Link className="img-footer1">
